		...
		<footer role="contentinfo">
			...
			programming is copyright <i class="fa fa-fw fa-copyright" aria-hidden="true" title="copyright"></i>
			2013 - $year <a href="http://dashifen.com">David Dashifen Kees</a>.</p>
		</footer>
	</div> <!-- #shadowlab -->
	
	<script>var vueData = $vueData</script>
	<script src="/assets/scripts/shadowlab.js"></script>
</body>
</html>
